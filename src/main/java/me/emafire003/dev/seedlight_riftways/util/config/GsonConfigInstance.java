package me.emafire003.dev.seedlight_riftways.util.config;
 ...
 *
 * Only fields annotated with {@link me.emafire003.dev.seedlight_riftways.util.config.ConfigEntry} are included in the JSON.
...
public class GsonConfigInstance<T> extends ConfigInstance<T> {
    ...
    public void save() {
        try {
            SeedLightRiftways.LOGGER.info("Saving {}...", getConfigClass().getSimpleName());
    ...
    public void load() {
        try {
            ...
            SeedLightRiftways.LOGGER.info("Loading {}...", getConfigClass().getSimpleName());
