package me.emafire003.dev.seedlight_riftways.blocks.inactiveriftblock;
...
public class InactiveRiftwayBlockEnity extends RiftWayBlockEntity {
    public InactiveRiftwayBlockEnity(BlockPos blockPos, BlockState blockState) {
